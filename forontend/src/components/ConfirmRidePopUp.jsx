...
const ConfirmRidePopUp = (props) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <h3 className='text-2xl font-semibold mt-4'>Confirm this ride to Start</h3>
            ...
            <form onSubmit={submitHandler} className="space-y-4">
                <input 
                    ...
                    type="text" 
                    className='w-full px-4 py-3 bg-gray-50 font-mono text-lg rounded-xl 
                ...
                <div className="space-y-2">
                    ...
                    <button 
                        ...
                        className='w-full bg-gray-100 text-gray-700 font-medium py-3.5 
                        rounded-xl hover:bg-gray-200 active:scale-[0.98] transition-all'
                    >
                        Cancel
                    </button>
                </div>
